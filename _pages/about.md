...
I'm a PhD in [Human-Computer Interaction](https://www.hcii.cmu.edu/){:target="_blank"} student at Carnegie Mellon University's [School of Computer Science](https://www.cs.cmu.edu/){:target="_blank"}. My research focuses on developing **data science methods and data-driven user interfaces for understanding and augmenting human behavior**, with the goal of advancing high-impact application areas like health, well-being, computer-mediated communication, and collaboration. 
